...
\newcommand{\code}[1]{\text{\scriptsize\texttt{\detokenize{#1}}}}
...
\input{methodology_post_process}
...
We have presented \textit{Excel Shrink}, a tool that significantly reduces the file sizes of \textit{Excel} sheets by eliminating unnecessary content. Our analysis identified common practices that lead to bloated \textit{Excel} files and demonstrated how targeted removal of redundant data can achieve reductions of up to 99.99\% in real-world Excel files without altering the spreadsheets' appearance.

Our tool outperforms existing solutions in both file size reduction, preservation of formatting and performance. By making \textit{Excel Shrink} available to the community, we hope to facilitate more efficient data processing and analysis of large-scale \textit{Excel} datasets.
