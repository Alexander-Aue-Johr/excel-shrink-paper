...
def plot_distribution(data: pd.DataFrame, output_path: Path, preview_output_path: Path) -> None:
    ...
    ax_combined.set_title("Rust Combined Reduction Ratio", fontsize=18)
    ...
    fig.text(
        0.5,
        0.035,
        "Excel Sheets / Workbook Entries (Index)",
        ha="center",
        fontsize=13,
    )
    fig.text(
...
def main() -> None:
    ...
    print(f"Plotted entries: {len(distribution_data)}")
