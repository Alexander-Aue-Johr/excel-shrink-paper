...
def remove_consecutive_hidden_self_closing_rows_all_lazy(
    sheet_data: bytes, params: CleanSheetParameters
) -> bytes:
    return apply_pattern_substitution(
        sheet_data,
        pattern_hidden_self_closing_rows_ignoring_first_non_empty_all_lazy,
        rb"\1",
        "pattern_hidden_rows",
        params,
    )
...
def remove_consecutive_hidden_self_closing_rows_last_not_lazy(
    sheet_data: bytes, params: CleanSheetParameters
) -> bytes:
    return apply_pattern_substitution(
        sheet_data,
        pattern_hidden_self_closing_rows_ignoring_first_non_empty_last_not_lazy,
        rb"\1",
        "pattern_hidden_rows",
        params,
    )
...
def remove_consecutive_hidden_self_closing_rows(
    sheet_data: bytes, params: CleanSheetParameters
) -> bytes:
    return apply_pattern_substitution(
        sheet_data,
        pattern_hidden_self_closing_rows_ignoring_first_non_empty,
        rb"\1",
        "pattern_hidden_rows",
        params,
    )
...
def remove_consecutive_hidden_self_closing_rows_not_ignoring_first_non_empty_tempered_dot(
    sheet_data: bytes, params: CleanSheetParameters
) -> bytes:
    return apply_pattern_substitution(
        sheet_data,
        pattern_hidden_self_closing_rows_not_ignoring_first_non_empty_tempered_dot,
        rb"\1",
        "pattern_hidden_self_closing_rows_not_ignoring_first_non_empty_tempered_dot",
        params,
    )
...
def remove_pattern_hidden_rows_lazy(
    sheet_data: bytes, params: CleanSheetParameters
) -> bytes:
    return apply_pattern_substitution(
        sheet_data, pattern_hidden_rows_lazy, rb"\1", "pattern_hidden_rows_lazy", params
    )


pattern_hidden_rows_posessive = re.compile(
    rb'(<row\b[^/>]*?\bhidden="1"[^/>]++(?:/>|>(?:(?!(?:</row>|<v\b|<f\b)).)++</row>))(?:<row\b[^/>]*?\bhidden="1"[^/>]++(?:/>|>(?:(?!(?:</row>|<v\b|<f\b)).)++</row>))+'
)
