...
Excel supports rich formatting options for cells—such as fonts, colours, number formats, and borders—and manages these through style records. Each style record represents a specific combination of formatting properties and can be shared among multiple cells, rows, or columns.
