...
apply_protection_pattern = re.compile(b'applyProtection="([^"]+)"')
...
def parse_xfs(cell_styles: bytes) -> List[XF]:
    ...
    for xf in xf_matches:
        ...
        apply_protection = get_attr(xf, apply_protection_pattern) == b"1"
